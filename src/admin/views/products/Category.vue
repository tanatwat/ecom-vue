  ...
  <div>
    ...
    <div class="w-row">
      <div class="left-column w-col w-col-6">
        <div class="section-wrapper">
          ...
          <div class="data-list-wrapper w-clearfix">
            <div>
              <div class="data-list-heading">Category</div>
            </div>
            <div class="data-list-body">
              <div class="data-list-text">Subcategory</div>
              <div class="data-list-text">Subcategory</div>
            </div>
            <div class="action-wrapper"><a href="#" class="button-icon edit w-button">Edit</a><a href="#" class="button-icon delete w-button">Delete</a></div>
          </div>
      ...
      <div class="right-column w-col w-col-6">
        <div class="section-wrapper">
          <h3 class="section-heading">เพิ่มหมวดหมู่สินค้า</h3>
          <div class="w-form">
            <form id="email-form" name="email-form" data-name="Email Form">
              ...
              <div class="radio-input w-radio"><input type="radio" id="radio" name="radio" value="Radio" data-name="Radio" class="radio-button w-radio-input"><label for="radio" class="radio-label w-form-label">Radio</label></div>
              <div class="form-group"><label for="name-2" class="form-label">Label</label><input type="text" id="name-2" name="name-2" data-name="Name 2" maxlength="256" class="form-input w-input"></div>
